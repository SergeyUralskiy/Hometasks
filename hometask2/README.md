...
Для ускорения работ в случае разворачивания нескольких виртуальных машин вышеуказанные команды внесены в Vagrantfile
в секции provision.

Соответственно для разворачивания виртуальной машины и обновления ядра теперь достаточно двух команд:
vagrant up
vagrant provisoin
